...
secp256k1_blake160-via-docker:
	docker run --rm -v `pwd`:/code ${BUILDER_DOCKER} bash -c "cd /code && make build/secp256k1_blake160.a"

build/secp256k1_blake160.a: build/secp256k1_blake160.o
	$(AR) rcs $@ $^

build/secp256k1_blake160.o: c/secp256k1_blake160.c ${PROTOCOL_HEADER} c/secp256k1_lock.h build/secp256k1_data_info.h $(SECP256K1_SRC)
	$(CC) $(CFLAGS) -c -o $@ $<
